...
function donutCraft(event, output, center, ring) {
	event.shaped(output, [
		'SSS',
		'SCS',
		'SSS'
...
function tweaks(event) {
	...
	event.stonecutting(KJ("circuit_scrap"), KJ("circuit_scrap"))
	event.stonecutting(KJ("circuit_scrap"), KJ("circuit_scrap"))
	event.stonecutting(KJ("circuit_scrap"), KJ("circuit_scrap"))
	event.stonecutting(KJ("circuit_scrap"), KJ("circuit_scrap"))
...
function electronTube(event) {
	...
	event.recipes.createMechanicalCrafting(Item.of(KJ('certus_gem_seed'), 2), ['A'], { A: KJ('purified_certus_gem') })
	event.recipes.createMechanicalCrafting(Item.of(KJ('nether_gem_seed'), 2), ['A'], { A: KJ('purified_nether_gem') })
	event.recipes.createMechanicalCrafting(Item.of(KJ('fluix_gem_seed'), 2), ['A'], { A: KJ('purified_fluix_gem') })
	...
	grow(KJ("certus_gem_seed"), KJ('growing_certus_seed'), KJ('tiny_certus_gem'))
	grow(KJ("fluix_gem_seed"), KJ('growing_fluix_seed'), KJ('tiny_fluix_gem'))
	grow(KJ("nether_gem_seed"), KJ('growing_nether_seed'), KJ('tiny_nether_gem'))

	grow(KJ("tiny_certus_gem"), KJ('growing_tiny_certus_gem'), KJ('small_certus_gem'))
	grow(KJ("tiny_fluix_gem"), KJ('growing_tiny_fluix_gem'), KJ('small_fluix_gem'))
	grow(KJ("tiny_nether_gem"), KJ('growing_tiny_nether_gem'), KJ('small_nether_gem'))

	grow(KJ("small_certus_gem"), KJ('growing_small_certus_gem'), KJ('purified_certus_gem'))
	grow(KJ("small_fluix_gem"), KJ('growing_small_fluix_gem'), KJ('purified_fluix_gem'))
	grow(KJ("small_nether_gem"), KJ('growing_small_nether_gem'), KJ('purified_nether_gem'))
	...
	event.recipes.createMixing([KJ('purified_certus_gem'), Fluid.of(TE("redstone"), 250)], [AE2('charged_certus_quartz_crystal'), Fluid.of(TC("molten_obsidian"), 250)])
	event.recipes.createMixing(['create:polished_rose_quartz'], [[KJ('purified_nether_gem'), KJ('purified_certus_gem')], Fluid.of(TE("redstone"), 250)])
