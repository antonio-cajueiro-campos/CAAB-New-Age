...
StartupEvents.registry('item', event => {
	...
	types.forEach(e => {
		...
		event.create("purified_" + id + '_gem').texture("kubejs:item/purified_" + id + "_gem").displayName(e + ' Gem')
		event.create(id + '_gem_seed').texture("kubejs:item/gem_seed_" + id).displayName(e + ' Gem Seed')
		event.create('growing_' + id + '_seed', 'create:sequenced_assembly').texture("kubejs:item/gem_seed_" + id).displayName(e + ' Gem Seed')
		event.create('tiny_' + id + '_gem').texture("kubejs:item/gem_seed_" + id + "2").displayName('Tiny ' + e + ' Gem')
		event.create('growing_tiny_' + id + '_gem', 'create:sequenced_assembly').texture("kubejs:item/gem_seed_" + id + "2").displayName('Tiny ' + e + ' Gem')
		event.create('small_' + id + '_gem').texture("kubejs:item/gem_seed_" + id + "3").displayName('Small ' + e + ' Gem')
		event.create('growing_small_' + id + '_gem', 'create:sequenced_assembly').texture("kubejs:item/gem_seed_" + id + "3").displayName('Small ' + e + ' Gem')
	});
	...
	for (var i = 0; i < slime_types.length; i++) {
